...
User_1.default.hasMany(Event_1.default, { foreignKey: 'authorId', as: 'events' });
Event_1.default.belongsTo(User_1.default, { foreignKey: 'authorId', as: 'author' });
...
User_1.default.hasMany(RSVP_1.default, { foreignKey: 'userId' });
RSVP_1.default.belongsTo(User_1.default, { foreignKey: 'userId' });
